...
func migrateDB() error {
	...
	err := DB.AutoMigrate(
		...
		&Team{},
		&TeamMember{},
		&HermesTeamConversation{},
		&HermesUserConversation{},
		&HermesExecutionTask{},
		&HermesResult{},
		&User{},
		&PasskeyCredential{},
...
func migrateDBFast() error {
	...
	migrations := []struct {
		...
		{&HermesTeamConversation{}, "HermesTeamConversation"},
		{&HermesUserConversation{}, "HermesUserConversation"},
		{&HermesExecutionTask{}, "HermesExecutionTask"},
		...
		{&VideoPlaygroundHistory{}, "VideoPlaygroundHistory"},
