...
import (
	...
	_ "github.com/BaizorAI/new-api/oauth"
...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/cli/poll", controller.PollCliSession)
		apiRouter.GET("/models", middleware.UserAuth(), controller.DashboardListModels)
		apiRouter.GET("/status/test", middleware.AdminAuth(), controller.TestStatus)
		apiRouter.GET("/smtp/test", middleware.AdminAuth(), controller.SendTestEmail)
		apiRouter.GET("/admin/online-status", middleware.AdminAuth(), controller.GetOnlineStatus)
		...
		// Model metadata sync — downstream sites pull model/vendor catalogs from here.
		apiRouter.GET("/newapi/models.json", controller.GetUpstreamModels)
		apiRouter.GET("/newapi/vendors.json", controller.GetUpstreamVendors)
		...
		apiRouter.POST("/subscription/wechat-pay/notify", controller.SubscriptionWeChatPayNotify)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/heartbeat", controller.RecordHeartbeat)
				...
				selfRoute.POST("/pay", middleware.CriticalRateLimit(), controller.LegacyCompatPay) // 兼容旧前端，重定向到微信支付
		...
		teamRoute.Use(middleware.UserAuth())
		{
			...
			teamRoute.GET("/:id/member_candidates", middleware.SearchRateLimit(), controller.SearchTeamMemberCandidates)
			teamRoute.POST("/:id/members", controller.AddTeamMember)
			teamRoute.PUT("/:id/members/:user_id", controller.UpdateTeamMemberRole)
			teamRoute.DELETE("/:id/members/:user_id", controller.RemoveTeamMember)
			teamRoute.GET("/:id/hermes/conversations", controller.ListTeamHermesConversations)
		...
		imagePlaygroundRoute.Use(middleware.UserAuth())
		{
			...
			imagePlaygroundRoute.POST("/generate", controller.SubmitImagePlaygroundGeneration)
