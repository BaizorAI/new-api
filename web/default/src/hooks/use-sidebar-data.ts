  ...
  return {
    navGroups: [
      ...
      },
      {
        id: 'film-studio',
        title: t('Film Studio'),
        description: t('AI-powered film production: image, video, and full pipeline.'),
        icon: Clapperboard,
        ...
        items: [
          ...
          {
            title: t('Video Lab'),
            description: t('Generate video clips with camera control and timeline editing.'),
          ...
          },
          {
            ...
            description: t('Characters, storyboards, clips, LoRA models — synced across all tools.'),
            url: '/asset-center',
