...
export const STATIC_I18N_KEYS = [
  ...
  // Sidebar modules
  'Workspaces',
  'Team, personal, and AI workspaces.',
  'Model Playground',
  'AI model testing environment',
  'Chat session management',
  'Management Backend',
  'Access keys, usage records, and management overview.',
  'Data Dashboard',
  'Usage metrics and trend charts.',
  'Flow',
  'Flow Filters',
  'Filter the traffic flow view by time range and user.',
  'Requests',
  'Access Keys',
  'Create and manage integration keys.',
  'Usage Details',
  'Detailed request records for review.',
  'Drawing Records',
  ...
  'Mark this stage as complete to unlock the next stage.',
  'Project Brief',
  'Describe the story or concept...',
  'Optional. Up to 500 characters.',
  'Set up a new film project. Fill in the brief to have AI auto-generate the initial script.',
  'Ready to start?',
  'AI will generate an initial script based on your project brief.',
