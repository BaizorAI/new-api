...
const defaultModelSettings: ModelSettings = {
  ...
  'cli_default_model.model': 'huayu-v2',
  'cli_default_model.haiku_model': 'huayu-v2',
  'cli_default_model.sonnet_model': 'huayu-v2',
  'cli_default_model.opus_model': 'huayu-v2-max',
