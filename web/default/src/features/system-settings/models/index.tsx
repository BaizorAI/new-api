...
const defaultModelSettings: ModelSettings = {
  ...
  'cli_default_model.model': 'huazhen-v1',
  'cli_default_model.haiku_model': 'huazhen-v1',
  'cli_default_model.sonnet_model': 'huazhen-fable-5',
  'cli_default_model.opus_model': 'huazhen-fable-5',
  'cli_default_model.codex_model': '',
  'cli_default_model.codex_full_auto': true,
  'cli_default_model.codex_reasoning_effort': 'medium',
  'cli_default_model.claude_model': '',
  'cli_default_model.claude_max_turns': 0,
  'cli_default_model.claude_permission_mode': 'bypassPermissions',
