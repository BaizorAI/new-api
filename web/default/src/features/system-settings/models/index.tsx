...
const defaultModelSettings: ModelSettings = {
  ...
  'cli_default_model.model': 'deepseek-v4-pro-max',
  'cli_default_model.haiku_model': 'deepseek-v4-pro-max',
  'cli_default_model.sonnet_model': 'deepseek-v4-pro',
  'cli_default_model.opus_model': 'deepseek-v4-pro-max',
