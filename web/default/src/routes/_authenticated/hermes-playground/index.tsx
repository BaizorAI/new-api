...
import { getOrCreatePlaygroundSessionId } from '@/features/playground/lib'
...
function HermesPlaygroundPage() {
  ...
  const storageScope = `hermes_user_${userId ?? 'anonymous'}`
  const sessionId = useMemo(
    () => getOrCreatePlaygroundSessionId(storageScope),
    [storageScope]
  )
  ...
  const requestHeaders = useMemo(
    () => ({
      ...
      'X-Baizor-Hermes-Session': sessionId,
    }),
    [sessionId]
  )
