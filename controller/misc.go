...
import (
	...
	"github.com/BaizorAI/new-api/setting/console_setting"
...
func GetStatus(c *gin.Context) {
	...
	data := gin.H{
		...
		"docs_link":                   func() string { link := operation_setting.GetGeneralSetting().DocsLink; if strings.HasPrefix(link, "http") { return "/docs" }; return link }(),
